 ...
 *      `workspace:` coordinate or private `@first-tree/{cloud-client,
 *      client-runtime, client-providers}` package name in any dependency
...
const PRIVATE_CLIENT_IMPORT_RE =
  /(?:from|import)\s*\(?\s*["']@first-tree\/(?:cloud-client|client-runtime|client-providers)(?:\/[^"']*)?["']/g;
