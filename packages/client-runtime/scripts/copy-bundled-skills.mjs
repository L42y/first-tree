...
// into `packages/client-runtime/skills/` so they ship inside the @first-tree/client-runtime
...
// The skill set that ships with @first-tree/client-runtime. Kept hand-maintained
