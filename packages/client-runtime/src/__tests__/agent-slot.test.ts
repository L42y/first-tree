...
import { type FirstTreeHubSDK, type RegisterResult, SdkError } from "@first-tree/cloud-client";
...
function installMocks(
  ...
  vi.doMock("@first-tree/cloud-client/observability", () => ({
...
describe("AgentSlot", () => {
  afterEach(() => {
    ...
    vi.doUnmock("@first-tree/cloud-client/observability");
