...
describe("managed Skill reconciler", () => {
  ...
  it("keeps every provider reconcile call on the unsafe-discovery throwing contract", () => {
    const handlerSources = [
      "../client-providers/src/providers/claude/index.ts",
      "../client-providers/src/providers/claude/tui/index.ts",
      "../client-providers/src/providers/codex/sdk.ts",
      "../client-providers/src/providers/codex/app-server/index.ts",
      "../client-providers/src/providers/cursor/index.ts",
      "../client-providers/src/providers/kimi-code/index.ts",
      "../client-providers/src/providers/opencode/index.ts",
      "../client-providers/src/providers/pi/index.ts",
