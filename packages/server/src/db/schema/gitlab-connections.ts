...
export const gitlabConnections = pgTable(
  "gitlab_connections",
  {
    ...
    /** Most recent valid inbound event received through a GitLab System Hook. */
    lastSystemHookInboundAt: timestamp("last_system_hook_inbound_at", { withTimezone: true }),
    /** Most recent valid inbound event received through a GitLab Project Hook. */
    lastProjectHookInboundAt: timestamp("last_project_hook_inbound_at", { withTimezone: true }),
