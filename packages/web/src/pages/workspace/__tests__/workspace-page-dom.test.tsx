...
describe("WorkspacePage DOM behavior", () => {
  it("preserves canonical URL params and exposes list-driven URL transitions", async () => {
    ...
    const { container, root } = await renderDom(
      "/?c=chat-1&origin=manual&docChat=old&docMsg=m&docAttachment=att&docAgent=agent-1&docPath=readme",
      <WorkspacePage />,
    );
    ...
    // Current attachment-ref params survive the initial render.
    ...
    // Switching chat clears the doc-preview overlay so no stale preview lingers.
