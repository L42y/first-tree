...
export const SCENARIOS: readonly {
  ...
  {
    id: "workspace-chat",
    route: "/?c=SEED_CHAT_ID",
    waitFor: "[data-testid=chat-view]",
    note: "Chat thread with message + Send input",
  },
  { id: "agents-list", route: "/team", waitFor: "main", note: "DenseTable heavy" },
  { id: "agent-detail", route: "/agents/SEED_AGENT_ID", waitFor: "#ad-identity", note: "All Panels + Danger Zone" },
  { id: "computers", route: "/settings/computers", waitFor: "main", note: "ConnectStrip + DenseTable" },
  {
    id: "members",
    route: "/team",
    waitFor: "main",
