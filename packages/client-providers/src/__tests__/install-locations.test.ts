...
import { versionManagerBinDirs, wellKnownBinDirs } from "@first-tree/client-runtime/runtime/install-locations.js";
import {
  getLoginShellPathDirs,
  resetLoginShellPathDirsCache,
} from "@first-tree/client-runtime/runtime/login-shell-path.js";
