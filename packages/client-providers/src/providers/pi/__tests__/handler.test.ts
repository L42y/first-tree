...
import { clearGitRepoIdentityCacheForTests } from "@first-tree/client-runtime/runtime/git-repo-identity.js";
...
import * as managedSkills from "@first-tree/client-runtime/runtime/managed-skills.js";
import type {
  ProviderProcessSpec,
