...
vi.mock("@first-tree/client-runtime/runtime/agent-briefing.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("@first-tree/client-runtime/runtime/agent-briefing.js")>();
  return {
    ...actual,
