...
import { formatInboundContent } from "@first-tree/client-runtime/runtime/agent-io.js";
...
vi.mock("@first-tree/client-runtime/runtime/agent-bootstrap.js", () => ({
...
vi.mock("@first-tree/client-runtime/runtime/agent-briefing.js", () => ({
