...
vi.unmock("@first-tree/client-runtime/runtime/managed-skills.js");
...
vi.mock("@first-tree/client-runtime/runtime/agent-bootstrap.js", () => ({ ensureAgentBootstrap: vi.fn() }));
vi.mock("@first-tree/client-runtime/runtime/bootstrap.js", () => ({
...
vi.mock("@first-tree/client-runtime/runtime/agent-briefing.js", () => ({ buildAgentBriefing: vi.fn(() => "") }));
vi.mock("@first-tree/client-runtime/runtime/chat-context.js", () => ({
...
vi.mock("@first-tree/client-runtime/runtime/source-repos.js", () => ({
