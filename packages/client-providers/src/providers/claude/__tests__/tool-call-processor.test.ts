...
import type { ContextTreeGitWriteTracker } from "@first-tree/client-runtime/runtime/context-tree-git-status.js";
...
import { createToolCallProcessor, treeNodePathOf } from "../tool-call-processor.js";
 ...
 *
 * The processor lives in `providers/claude/tool-call-processor.ts`, shared by
