import type { HandlerFactory } from "@first-tree/client-runtime/contracts";
...
/** Narrow log seam — composition supplies cloud-client createLogger; providers never import it. */
