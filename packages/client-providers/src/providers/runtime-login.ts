...
import type { LoginOutcome } from "@first-tree/client-runtime/contracts";
import { redactErrorPreview } from "@first-tree/client-runtime/provider-support";

export type { LoginOutcome } from "@first-tree/client-runtime/contracts";
 ...
 *
 * Lives under `providers/` so feature-first provider families can share it
 * without deep-importing Runtime owner modules. The {@link LoginOutcome} type
 * remains Runtime-owned via `runtime/contracts`.
 */
